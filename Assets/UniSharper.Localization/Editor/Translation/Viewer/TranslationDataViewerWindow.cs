...
{
    internal class TranslationDataViewerWindow : LocalizationEditorWindow
    {
        private const string Title = "Translation Data Viewer";
        ...
        [MenuItem("UniSharper/Localization Management/Translation/View in Translation Data Viewer Window...", false, 2)]
        internal static void ShowWindow()
        {
            ...
            {
                GetWindow<TranslationDataViewerWindow>(Title).Show();
            }
            else
            {
